...
(function ($) {
    function _58b(_58c) {
        ...
        _58e.push({
            iconCls: "numberspinner-arrow", handler: function (e) {
                _58f(e);
            }
        });
        $(_58c).addClass("numberspinner-f").textbox($.extend({}, opts, {icons: _58e}));
        var _590 = $(_58c).textbox("getIcon", _58e.length - 1);
        _590.append("<a href=\"javascript:void(0)\" class=\"numberspinner-arrow-up\" tabindex=\"-1\"></a>");
        _590.append("<a href=\"javascript:void(0)\" class=\"numberspinner-arrow-down\" tabindex=\"-1\"></a>");
    ...
    function _58f(e) {
        ...
        var up = $(e.target).closest("a.numberspinner-arrow-up");
        if (up.length) {
            opts.spin.call(_591, false);
            opts.onSpinUp.call(_591);
            $(_591).spinner("validate");
        }
        var down = $(e.target).closest("a.numberspinner-arrow-down");
        if (down.length) {
